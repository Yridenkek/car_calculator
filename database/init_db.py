...
def fill_sample_data():
    ...
    total_cars = [
        ...
        ("Geely", "Cityray", 2026, "Comfort", 2849990, 2739990, 0, 0, 180000, 220000),
        ("Geely", "Cityray", 2026, "Luxury", 3094990, 2964990, 0, 0, 180000, 220000),
        ("Geely", "Cityray", 2026, "Flagship", 3214990, 3074990, 0, 0, 180000, 220000),
        ("Geely", "Cityray", 2026, "Sport", 3254990, 3114990, 0, 0, 180000, 220000),
