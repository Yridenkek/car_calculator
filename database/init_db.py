...
def fill_sample_data():
    ...
    total_cars = [
        ("Geely", "Monjaro", 2025, "Flagship SE", 4899990, 4579990,0, 0, 200000, 250000),
        ("Geely", "Monjaro", 2026, "Luxury SE", 4599990, 4379990, 0, 0, 200000, 250000),
        ("Geely", "Monjaro", 2026, "Flagship SE", 4899990, 4579990, 0, 0, 200000, 250000),
        ...
        ("Geely", "Atlas", 2026, "Luxury", 3904990, 3744990, 0, 0, 160000, 0),
        ("Geely", "Atlas", 2026, "Flagship", 4114990, 3944990, 0, 0, 160000, 0),
        ...
        ("Geely", "Okavango", 2026, "Flagship", 3988990, 3783990, 0, 0, 300000, 350000),
        ("Geely", "Preface", 2026, "Luxury", 3329990, 1, 0, 0, 250000, 0),
        ("Geely", "Preface", 2026, "Flagship", 3429990, 3279990, 0, 0, 250000, 0),
        ...
        ("Geely", "Cityray", 2026, "Luxury", 3094990, 2964990, 0, 0, 230000, 270000),
        ("Geely", "Cityray", 2026, "Flagship", 3214990, 3074990, 0, 0, 230000, 270000),
        ("Geely", "Cityray", 2026, "Sport", 3254990, 3114990, 0, 0, 230000, 270000),
        ("Geely", "Coolray", 2026, "Exclusive", 2889990, 2757990, 0, 0, 150000, 0),
        ("Geely", "EX5 EM-i", 2026, "Pro", 3669990, 1, 50000, 0, 0, 250000),
        ("Geely", "EX5 EM-i", 2026, "Max", 3969990, 3752900, 50000, 0, 0, 250000),        
