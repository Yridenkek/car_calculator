...
def fill_sample_data():
    ...
    total_cars = [
        ...
        ("Geely", "Cityray", 2026, "Luxury", 3204990, 3076600, 0, 0, 280000, 320000),
        ("Geely", "Cityray", 2026, "Flagship", 3344990, 3206600, 0, 0, 280000, 320000),
        ("Geely", "Cityray", 2026, "Sport", 3384990, 3246600, 0, 0, 280000, 320000),
        ...
        ("Geely", "EX5 EM-R", 2026, "Max", 3829990, 3614800, 0, 0, 250000, 0),        
        ("Geely", "EX5 EM-i", 2026, "Max", 3974990, 3759800, 50000, 0, 0, 250000),    
        ("Haval", "Poer", 2026, "Comfort MT 2.0T", 3449000, 1, 0, 0, 0, 0),
        ("Haval", "Poer", 2026, "Comfort MT 2.0D", 3449000, 1, 0, 0, 0, 0),    
        ...
        ("Haval", "F7 MY26", 2026, "Elite 1,5T 2WD", 2999000, 1, 0, 0, 0, 0),
        ("Haval", "F7 MY26", 2026, "Premium 1,5T 2WD", 3199000, 1, 0, 0, 0, 0),
        ("Haval", "F7 MY26", 2026, "Elite 2.0T 4WD", 3399000, 1, 0, 0, 0, 0),
        ("Haval", "F7 MY26", 2026, "Premium 2.0T 4WD", 3599000, 1, 0, 0, 0, 0),
        ("Haval", "F7 MY26", 2026, "Tech plus 2.0T 4WD", 3799000, 1, 0, 0, 0, 0),
        ("Haval", "F7x", 2026, "Premium", 3599000, 1, 0, 0, 0, 0),
        ("Haval", "F7x", 2026, "Tech plus", 3799000, 1, 0, 0, 0, 0),        
        ("Haval", "F7x MY26", 2026, "Premium", 3799000, 1, 0, 0, 0, 0),
        ("Haval", "F7x MY26", 2026, "Tech plus", 3999000, 1, 0, 0, 0, 0),        
        ("Haval", "M6 MY26", 2026, "Family MT", 2099000, 1946550, 0, 0, 0, 0),
        ("Haval", "M6 MY26", 2026, "Family AT", 2349000, 2231550, 0, 0, 0, 0),
        ("Haval", "Dargo", 2026, "Comfort", 3199000, 1, 0, 0, 0, 0),
        ("Haval", "Dargo", 2026, "Elite", 3499000, 3195060, 0, 0, 0, 0),
        ("Haval", "Dargo", 2026, "Premium", 3699000, 1, 0, 0, 0, 0),
        ("Haval", "Dargo", 2026, "Tech plus", 3899000, 3524060, 0, 0, 0, 0),
        ("Haval", "Dargo X", 2026, "Elite", 3499000, 3289060, 0, 0, 0, 0),
        ("Haval", "Dargo X", 2026, "Premium", 3699000, 3477060, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Comfort 2WD", 2099000, 1946550, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Elite 2WD", 2499000, 2302060, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Premium 2WD", 2699000, 2490060, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Elite 4WD", 2649000, 2443060, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Premium 4WD", 2849000, 2631060, 0, 0, 0, 0),
        ("Haval", "Jolion MY26", 2026, "Tech plus 4WD", 2949000, 2725060, 0, 0, 0, 0),
