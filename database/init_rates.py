...
def fill_rates_geely():
    ...
    rates_data = [
    (0,  0.01, 14.5, 14.8, 15.7, 15.8, 17.6, 17.8, 99.0),
    (10, 0.01, 7.70, 10.5, 11.8, 12.6, 13.5, 13.8, 99.0),
    (20, 0.01, 6.60, 9.20, 10.3, 10.8, 12.4, 12.6, 12.7),
    (30, 0.01, 4.90, 8.20, 9.30, 10.5, 10.6, 11.4, 11.5),
    (40, 0.01, 2.90, 6.60, 7.90, 9.00, 9.70, 10.6, 10.6),
    (50, 0.01, 0.01, 3.50, 5.20, 7.00, 8.50, 9.40, 9.40),
    (60, 0.01, 0.01, 0.01, 2.50, 3.70, 5.50, 5.60, 7.20),
    (70, 0.01, 0.01, 0.01, 0.01, 0.01, 1.20, 2.50, 3.40),
...
def fill_rates_geely_cityray():
    ...
    rates_data = [
    (0,   0.01, 14.0, 14.8, 15.7, 15.8, 16.0, 17.1, 99.0),
    (10,  0.01, 7.30, 9.60, 11.2, 12.1, 12.9, 12.9, 12.9),
    (20,  0.01, 5.90, 8.90, 10.5, 11.5, 12.3, 12.3, 12.5),
    (30,  0.01, 4.10, 7.70, 8.70, 10.3, 11.5, 11.6, 11.6),
    (40,  0.01, 2.20, 5.50, 7.10, 8.10, 8.80, 10.3, 10.6),
    (50,  0.01, 0.01, 1.60, 5.20, 7.10, 8.00, 8.70, 9.30),
    (60,  0.01, 0.01, 0.01, 1.90, 3.90, 5.10, 5.30, 6.00),
    (70,  0.01, 0.01, 0.01, 0.01, 0.01, 1.20, 2.20, 3.10),
    (80,  0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01)
    ]
