...
def fill_rates_geely():
    ...
    rates_data = [
        (0,   0.01, 13.5, 15.0, 15.6, 15.6, 16.5, 17.5, 17.9),
        (10,  0.01, 13.5, 15.0, 15.6, 15.6, 16.5, 17.5, 17.9),
        (20,  0.01, 5.50, 8.00, 9.20, 10.5, 11.5, 12.0, 12.5),
        (30,  0.01, 3.00, 6.50, 7.50, 9.30, 10.5, 11.0, 11.5),
        (40,  0.01, 1.00, 5.00, 6.00, 8.00, 9.50, 9.70, 10.5),
        (50,  0.01, 0.01, 2.90, 3.70, 6.50, 8.00, 9.00, 9.40),
        (60,  0.01, 0.01, 0.01, 1.00, 3.90, 5.50, 6.50, 8.00),
        (70,  0.01, 0.01, 0.01, 0.01, 0.01, 1.50, 3.00, 5.00),
